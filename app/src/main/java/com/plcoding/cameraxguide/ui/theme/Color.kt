...
val Primary = Color(0xFFE1FDFF)
val OnPrimary = Color(0xFF00363A)
val PrimaryContainer = Color(0xFF00F2FF)
...
val SecondaryContainer = Color(0xFFCE5DFF)
val OnSecondaryContainer = Color(0xFF480064)

val Tertiary = Color(0xFFF7F6FF)
